package com.example.xyz.haritakullanimi
...
import com.example.xyz.haritakullanimi.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonKonumGetir.setOnClickListener {
